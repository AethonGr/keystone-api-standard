...
The `endpoints` folder contains endpoint definitions for the API endpoints. These endpoints map API paths to their corresponding functionalities, ensuring a clear and organized structure for handling requests.
...
- This folder provides a modular approach to managing API paths, making it easier to maintain the APIs. 
- Users have the flexibility to implement only the endpoints they need, simplifying integration and customization.
